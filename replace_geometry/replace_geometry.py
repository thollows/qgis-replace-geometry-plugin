...
from .replace_geometry_dockwidget import ReplaceGeometryDockWidget
import os.path
...
class ReplaceGeometry:
    ...
    def __init__(self, iface):
        ...
        self.toolbar = self.iface.addToolBar(u'ReplaceGeometry')
        self.toolbar.setObjectName(u'ReplaceGeometry')

        #print "** INITIALIZING ReplaceGeometry"
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            #print "** STARTING ReplaceGeometry"
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = ReplaceGeometryDockWidget()
